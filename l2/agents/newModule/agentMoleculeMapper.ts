...
## Rules
- Only map concrete interactive elements: text inputs, number inputs, date/time pickers,
  money fields, buttons, selects, checkboxes, toggles, file uploads, search bars, etc.
- Do NOT map structural/layout elements: div, section, header, main, aside, form wrappers,
  grid containers, decorative spans
- For each element, choose the group and variant that best match the field name and context
